...
6. For each new non-reserved `.md` file, add YAML frontmatter with a non-empty `type`.
7. Keep root requirements canonical in `docs/gui-testability-analyzer-requirements.md`.
8. Use links and concise summaries instead of duplicating long requirement text.
9. Update `knowledge/log.md` for meaningful changes.
