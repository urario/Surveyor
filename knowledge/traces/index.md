...
- [UT-0005 Read-Only Acquisition Audit Behavior Evidence](ut-0005-read-only-audit-evidence.md) - Failing-first behavior-test evidence for the read-only audit spy that fails on any prohibited state-changing UIA pattern, covering the full DES-0014 prohibited list, the closed allow-list, the WM_GETTEXT boundary, and the R-QA-01 mutating-fake-provider counter-example; tests only, `IMP-0007` handed off.
