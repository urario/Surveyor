...
5. Both counter-examples were reverted; the final Application suite passed 28/28.

## Verification

| Command | Result |
| --- | --- |
| `dotnet test tests\Surveyor.Application.Tests\Surveyor.Application.Tests.csproj --no-restore` | PASS: 28 tests; Application line coverage 94.71% |
