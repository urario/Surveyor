...
* [ADR-0002 Adapter Technology Selection (proposed)](decisions/adr-0002-adapter-technology-selection.md) - Proposed decision record for the RSK-RD-001 spike with measurements integrated (TRC-0001): recommends raw COM UIA client, Windows.Graphics.Capture primary + PrintWindow fallback, unpackaged-primary packaging; human approval promotes it and opens the DES-0014/DES-0015/IMP-0013/IMP-0014 gates.
