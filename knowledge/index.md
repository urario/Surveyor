...
* [DES-0003 Module Interface Basic Design](design/des-0003-module-interface-basic-design.md) - Basic-design contracts for every port/use-case boundary, including the canonical `ITargetFacingPort` category on Discovery/UIA/Capture ports.
...
* [DES-0008 Project Structure and Test Harness Detailed Design](design/des-0008-project-structure-and-test-harness.md) - Project/test layout and the mechanically fixed UIA→Discovery project edge, Discovery→UIA production friend, methodless bridge/internal raw surface, forbidden-consumer metadata checks, deterministic build settings, and fixture harness.
...
* [DES-0011 Port DTOs, Status Model, and Use-Case Orchestration Detailed Design](design/des-0011-port-dtos-status-model-and-use-case-orchestration.md) - Application DTOs/orchestration plus the canonical `ITargetFacingPort` definition and inheritance by the three sanctioned ports.
...
* [DES-0014 Discovery, UIA/MSAA Acquisition, and Read-Only Audit Detailed Design](design/des-0014-discovery-uia-msaa-acquisition-and-read-only-audit.md) - Read-only discovery/UIA design with a Discovery-owned methodless bridge, internal raw registry/resolver/result visible only to UIA, raw-handle diagnostic counter-example, ordering, MTA/audit/legacy behavior, and #113 migration handoff.
* [DES-0015 Capture and Snapshot Correspondence Detailed Design](design/des-0015-capture-and-snapshot-correspondence.md) - WGC/PrintWindow capture, physical-pixel and overlay contracts, `SnapshotRef` projection, failure/multi-monitor handling, and a `CaptureBlobId` contract explicitly independent of the target bridge.
...
* [DES-0018 Composition Root and DI Detailed Design](design/des-0018-composition-root-and-di.md) - `M13` composition design: MEDI seams, headless/production split, complete wiring/invariants, marker sanctioned-set enforcement, methodless Discovery/UIA bridge with exact architecture checks, prerequisite `IMP-0018` (#113), and `UT-0013` (#52) / `IMP-0015` (#73) handoff.
...
* [IMP-0013 Real UIA Acquisition Adapter Implementation](traces/imp-0013-uia-acquisition-adapter.md) - Historical #71 UIA adapter/registry evidence (57 tests), with the UIA-owned registry explicitly superseded downstream by `IMP-0018` #113 before composition.
* [IMP-0018 Discovery-Owned UIA Target Boundary](traces/imp-0018-discovery-uia-boundary.md) - Discovery-owned methodless bridge and raw table, UIA-only production reader, architecture mutation counter-examples, and raw-HWND confidentiality evidence for #113.
