...
* [DES-0014 Discovery, UIA/MSAA Acquisition, and Read-Only Audit Detailed Design](design/des-0014-discovery-uia-msaa-acquisition-and-read-only-audit.md) - Read-only discovery and raw-COM UIA/MSAA acquisition design: status/`TargetRef`/ordering, UIA MTA threading and cancellation, the RD-032 prohibited-pattern read-only audit and spy, legacy acquisition edge table, virtualized-tree handling, confidence rubric, rung-1 runtime-id detection, and the minimal-privilege policy.
