...
| Historical source placed public `UiaTargetHandleRegistry`, `uia-target-` minting, and the raw handle table under UIA; `IMP-0013` records 57 tests around that shape | [DES-0014](des-0014-discovery-uia-msaa-acquisition-and-read-only-audit.md) fixes Discovery as the token/raw-table owner and UIA as the sole reader | [IMP-0018](../traces/imp-0018-discovery-uia-boundary.md) #113 completed the registry, token prefix, public API, UIA constructor/test, and architecture-guard migration while preserving `IMP-0013` historically. Headless `UT-0013` #52 remains the other prerequisite to `IMP-0015` #73. |
...
- **Historical registry ownership** — closed by [IMP-0018](../traces/imp-0018-discovery-uia-boundary.md) #113. #73 must compose the Discovery-owned methodless bridge and may not reintroduce the historical resolver shape.
